...
!  write (*,*) 'file'
  ...
  file1 = 0 !valor do primeiro arquivo de leitura ex: campo_000000
  ...
  write(nfil,*)'    </Geometry>'
    ...
    write(nfil,*)'            <Attribute Name="V_error" AttributeType="Vector" Center="Node">'
    write(nfil,*)'               <DataItem Dimensions="',nz1,ny1,nx1,'3" Function="JOIN($0, $1, $2)"'
    write(nfil,*)'                         ItemType="Function">'
    write(nfil,*)'                  <DataItem  Format="Binary" DataType="Float" Precision="4" Endian="little"'
    write(nfil,*)'                     Seek="',nx1*ny1*nz1*4*6+4,'" Dimensions="',nz1,ny1,nx1,' 1">'
    write(nfil,*)'                     '//trim(a)//chits
    write(nfil,*)'                  </DataItem>'
    write(nfil,*)'                  <DataItem  Format="Binary" DataType="Float" Precision="4" Endian="little"'
    write(nfil,*)'                     Seek="',nx1*ny1*nz1*4*7+4,'" Dimensions="',nz1,ny1,nx1,' 1">'
    write(nfil,*)'                     '//trim(a)//chits
    write(nfil,*)'                  </DataItem>'
    write(nfil,*)'                  <DataItem  Format="Binary" DataType="Float" Precision="4" Endian="little"'
    write(nfil,*)'                     Seek="',nx1*ny1*nz1*4*8+4,'" Dimensions="',nz1,ny1,nx1,' 1">'
    write(nfil,*)'                     '//trim(a)//chits
    write(nfil,*)'                  </DataItem>'
    write(nfil,*)'               </DataItem>'
    write(nfil,*)'            </Attribute>'
    ...
    write(nfil,*)'                         ItemType="Function">'
    write(nfil,*)'                  <DataItem  Format="Binary" DataType="Float" Precision="4" Endian="little"'
    write(nfil,*)'                     Seek="',nx1*ny1*nz1*4*6+nx*ny*nz*4+4,'" Dimensions="',nz,ny,nx,' 1">'
    write(nfil,*)'                     '//trim(a)//chits
    write(nfil,*)'                  </DataItem>'
    write(nfil,*)'                  <DataItem  Format="Binary" DataType="Float" Precision="4" Endian="little"'
    write(nfil,*)'                     Seek="',nx1*ny1*nz1*4*6+nx*ny*nz*4*2+4,'" Dimensions="',nz,ny,nx,' 1">'
    write(nfil,*)'                     '//trim(a)//chits
    write(nfil,*)'                  </DataItem>'
    write(nfil,*)'                  <DataItem  Format="Binary" DataType="Float" Precision="4" Endian="little"'
    ...
    write(nfil,*)'               <DataItem Format="Binary" '
    write(nfil,*)'                DataType="Float" Precision="4" Endian="little" Seek="',nx1*ny1*nz1*4*6+nx*ny*nz*4*4+4,'"'
    write(nfil,*)'                Dimensions="',nz,ny,nx,'">'
    write(nfil,*)'                  '//trim(a)//chits
    write(nfil,*)'               </DataItem>'
    write(nfil,*)'            </Attribute>'
    ...
    write(nfil,*)'                         ItemType="Function">'
    write(nfil,*)'                  <DataItem  Format="Binary" DataType="Float" Precision="4" Endian="little"'
    write(nfil,*)'                     Seek="',nx1*ny1*nz1*4*6+4+nx*ny*nz*4*5,'" Dimensions="',nz,ny,nx,' 1">'
    write(nfil,*)'                     '//trim(a)//chits
    write(nfil,*)'                  </DataItem>'
    write(nfil,*)'                  <DataItem  Format="Binary" DataType="Float" Precision="4" Endian="little"'
    write(nfil,*)'                     Seek="',nx1*ny1*nz1*4*6+4+nx*ny*nz*4*6,'" Dimensions="',nz,ny,nx,' 1">'
    write(nfil,*)'                     '//trim(a)//chits
    write(nfil,*)'                  </DataItem>'
    write(nfil,*)'                  <DataItem  Format="Binary" DataType="Float" Precision="4" Endian="little"'
    write(nfil,*)'                     Seek="',nx1*ny1*nz1*4*6+4+nx*ny*nz*4*7,'" Dimensions="',nz,ny,nx,' 1">'
    write(nfil,*)'                     '//trim(a)//chits
    write(nfil,*)'                  </DataItem>'
    write(nfil,*)'               </DataItem>'
    write(nfil,*)'            </Attribute>'
