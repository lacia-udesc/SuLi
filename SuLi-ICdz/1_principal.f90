...
!Declaração de Variáveis!
	...
	!Solução manufaturada !desatualizada
	!if (mms_t > 0) CALL mms()
	...
	do it = 1, ts
		...
		!Termo fonte para o método da sulução manufaturada (MMS) !desatualizada
		...
		!Solução manufaturada; cálculo do erro !desatualizada
		!if (mms_t > 0) CALL mms()
